...
public class BreathingApparatus implements IBreathingArmorLogic {
    ...
    public ResourceLocation getArmorTexture(@NotNull ItemStack stack, @Nullable Entity entity,
        ...
        return switch (this.slot) {
            case HELMET -> ResourceLocation.fromNamespaceAndPath(Supersymmetry.MOD_ID, "textures/armor/gas_mask.png");
            case CHESTPLATE -> ResourceLocation.fromNamespaceAndPath(Supersymmetry.MOD_ID, "textures/armor/gas_tank.png");
            default -> null;
        };
    }
