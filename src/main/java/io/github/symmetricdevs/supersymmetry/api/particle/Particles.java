...
public class Particles {
    ...
    public static final Map<String, Particle> particleRegistry = new HashMap<>();
    ...
    public static void init() {
        ...
        electronNeutrino = new Particle("electron neutrino", 0.000002, 0, 0.5, 0.0, false, true,
                SuSyValues.susyId("particles/electron_neutrino.png"));
        muonNeutrino = new Particle("muon neutrino", 0.00019, 0, 0.5, 0.0, false, true,
                SuSyValues.susyId("particles/muon_neutrino.png"));
        tauNeutrino = new Particle("tau neutrino", 18.2, 0, 0.5, 0.0, false, true,
                SuSyValues.susyId("particles/tau_neutrino.png"));
        electron = new Particle("electron", 0.511, -1, 0.5, 0.0, false, true, SuSyValues.susyId("particles/electron.png"));
        muon = new Particle("muon", 105.66, -1, 0.5, 0.0, false, true, SuSyValues.susyId("particles/muon.png"));
        tau = new Particle("tau", 1776.86, -1, 0.5, 0.0, false, true, SuSyValues.susyId("particles/tau.png"));

        // Quarks
        up = new Particle("up", 2.2, +0.666f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/up.png"));
        down = new Particle("down", 4.7, -0.333f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/down.png"));
        strange = new Particle("strange", 96, -0.333f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/strange.png"));
        charm = new Particle("charm", 1270, +0.666f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/charm.png"));
        bottom = new Particle("bottom", 4180, -0.333f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/bottom.png"));
        top = new Particle("top", 172900, +0.666f, 0.5, 1400.0, true, true, SuSyValues.susyId("particles/top.png"));

        // AntiLeptons
        positron = new Particle("positron", 0.511, +1, 0.5, 0.0, false, true, SuSyValues.susyId("particles/positron.png"));
        antiMuon = new Particle("antimuon", 105.66, +1, 0.5, 0.0, false, true, SuSyValues.susyId("particles/antimuon.png"));
        antiTau = new Particle("antitau", 1776.86, +1, 0.5, 0.0, false, true, SuSyValues.susyId("particles/antitau.png"));
        electronAntineutrino = new Particle("electron antineutrino", 0.000002, 0, 0.5, 0.0, false, true,
                SuSyValues.susyId("particles/electron_antineutrino.png"));
        muonAntineutrino = new Particle("muon antineutrino", 0.00019, 0, 0.5, 0.0, false, true,
                SuSyValues.susyId("particles/muon_antineutrino.png"));
        tauAntineutrino = new Particle("tau antineutrino", 18.2, 0, 0.5, 0.0, false, true,
                SuSyValues.susyId("particles/tau_antineutrino.png"));

        // AntiQuarks
        antiUp = new Particle("antiup", 2.2, -0.666f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/antiup.png"));
        antiDown = new Particle("antidown", 4.7, +0.333f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/antidown.png"));
        antiStrange = new Particle("antistrange", 96, +0.333f, 0.5, 0.0, true, true,
                SuSyValues.susyId("particles/antistrange.png"));
        antiCharm = new Particle("anticharm", 1270, -0.666f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/anticharm.png"));
        antiBottom = new Particle("antibottom", 4180, +0.333f, 0.5, 0.0, true, true, SuSyValues.susyId("particles/antibottom.png"));
        antiTop = new Particle("antitop", 172900, -0.666f, 0.5, 1400.0, true, true, SuSyValues.susyId("particles/antitop.png"));

        // Gauge Bosons
        gluon = new Particle("gluon", 0.0, 0, 1.0, 0.0, true, false, SuSyValues.susyId("particles/gluon.png"));
        photon = new Particle("photon", 0.0, 0, 1.0, 0.0, false, false, SuSyValues.susyId("particles/photon.png"));
        WPlus = new Particle("W+ boson", 80379.0, +1, 1.0, 2085.0, false, true, SuSyValues.susyId("particles/WPlus.png"));
        WMinus = new Particle("W- boson", 80379.0, -1, 1.0, 2085.0, false, true, SuSyValues.susyId("particles/WMinus.png"));
        Z = new Particle("Z boson", 91187.6, 0, 1.0, 2495.0, false, true, SuSyValues.susyId("particles/Z_boson.png"));
        higgs = new Particle("Higgs boson", 125100.0, 0, 0.0, 4300.0, false, false, SuSyValues.susyId("particles/higgs.png"));
        ...
        // Composite particles
        proton = new Particle("proton", 938.272, +1, 0.5, 0, false, true, SuSyValues.susyId("particles/proton"));
        proton.addComponent(up, 2);
        proton.addComponent(down, 1);
        proton.addComponent(gluon, 0);
        antiProton = makeAntiParticle(proton, SuSyValues.susyId("particles/antiproton"));
        proton.setAntiParticle(antiProton);

        neutron = new Particle("neutron", 939.565, 0, 0.5, 0, false, true, SuSyValues.susyId("particles/neutron"));
        neutron.addComponent(up, 1);
        neutron.addComponent(down, 2);
        neutron.addComponent(gluon, 0);
        antiNeutron = makeAntiParticle(neutron, SuSyValues.susyId("particles/antineutron"));
    ...
    public static void registerParticle(Particle particle) {
        if (!particleRegistry.containsKey(particle.getName())) {
            ...
            SuSyValues.LOGGER.error("Particle {} cannot be registered as it already exists", particle.getName());
        }
    }
    ...
    public static Particle getByName(String name) {
        if (name != null) {
            if (particleRegistry.containsKey(name)) {
                ...
                SuSyValues.LOGGER.error("Particle {} does not exist", name);
            }
        }
        return null;
    }
