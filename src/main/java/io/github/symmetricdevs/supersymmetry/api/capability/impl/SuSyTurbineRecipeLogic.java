...
import io.github.symmetricdevs.supersymmetry.common.metatileentities.multi.electric.MetaTileEntitySUSYLargeTurbine;

public class SuSyTurbineRecipeLogic extends MultiblockFuelRecipeLogic {

    public SuSyTurbineRecipeLogic(MetaTileEntitySUSYLargeTurbine BlockEntity) {
        super(BlockEntity);
    }
