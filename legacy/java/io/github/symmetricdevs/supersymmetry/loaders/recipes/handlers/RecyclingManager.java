package io.github.symmetricdevs.supersymmetry.loaders.recipes.handlers;
...
import com.gregtechceu.gtceu.api.items.toolitem.ToolHelper;
import com.gregtechceu.gtceu.api.recipe.*;
import com.gregtechceu.gtceu.api.recipe.ingredient.GTRecipeFluidInput;
import com.gregtechceu.gtceu.api.recipe.ingredient.GTRecipeInput;
import com.gregtechceu.gtceu.api.data.chemical.ChemicalHelper;
import com.gregtechceu.gtceu.api.unification.material.MarkerMaterial;
import com.gregtechceu.gtceu.api.unification.material.Material;
import com.gregtechceu.gtceu.api.data.tag.TagPrefix;
import com.gregtechceu.gtceu.api.unification.stack.ItemAndMetadata;
import com.gregtechceu.gtceu.api.unification.stack.ItemMaterialInfo;
import com.gregtechceu.gtceu.api.unification.stack.MaterialStack;
import com.gregtechceu.gtceu.api.util.EnumValidationResult;
import com.gregtechceu.gtceu.api.util.ValidationResult;
import com.gregtechceu.gtceu.integration.groovy.GroovyScriptModule;
import it.unimi.dsi.fastutil.chars.Char2IntOpenHashMap;
import it.unimi.dsi.fastutil.objects.*;
import io.github.symmetricdevs.supersymmetry.api.recycling.MaterialRecyclable;
import io.github.symmetricdevs.supersymmetry.api.recycling.Recyclable;
import io.github.symmetricdevs.supersymmetry.api.recycling.toposort.TopologicalSort;
import io.github.symmetricdevs.supersymmetry.mixins.gregtech.OreDictUnifierAccessor;
import io.github.symmetricdevs.supersymmetry.mixins.gregtech.RecipeBuilderAccessor;
...
public class RecyclingManager {
    ...
    ///
    /// @implNote as long as [GTRecipeType#removeRecipe(Recipe)] is called in a groovy script it will be considered as a
    /// GrS recipe
    ...
    public static void buildAndRegister(RecipeBuilder<?> recipeBuilder, ItemStack output) {
        ...
        GTRecipeType<?> GTRecipeType = accessor.getRecipeMap();
        ...
        if (validationResult.getType() == EnumValidationResult.VALID) {
            ...
            if (GTRecipeType == RecipeMaps.ARC_FURNACE_RECIPES) {
                arcRecipes.put(recyclable, recipe);
            } else if (GTRecipeType == RecipeMaps.MACERATOR_RECIPES) {
