 ...
 */
@OnlyIn(Dist.CLIENT)
public class SusyParticleFlameLarge extends FlameParticle {

    protected float hugeFlameScale;

    public SusyParticleFlameLarge(ClientLevel level, double x, double y, double z,
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
                                       ...
                                       double xSpeed, double ySpeed, double zSpeed) {
            SusyParticleFlameLarge particle = new SusyParticleFlameLarge(level, x, y, z, xSpeed, ySpeed, zSpeed);
