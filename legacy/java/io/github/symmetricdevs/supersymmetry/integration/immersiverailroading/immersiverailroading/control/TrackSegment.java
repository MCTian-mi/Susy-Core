...
public class TrackSegment {
    ...
    public TrackSegment(RailSettings settings, float yawHead, Vec3 hit) {
    ...
    public TrackSegment(RailSettings settings, Vec3 placementPosition, TrackDirection direction, float yaw,
                        Vec3 control) {
        this.settings = settings;
        ...
        switch (this.settings.type) {
            case STRAIGHT:
                return this.info.placementPosition
                        .add(new Vec3(0, 0, this.settings.length + 1).rotateYaw(this.info.yaw));
            default:
                return this.info.placementPosition;
        }
    }
