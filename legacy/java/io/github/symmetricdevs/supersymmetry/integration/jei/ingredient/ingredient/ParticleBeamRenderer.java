...
import io.github.symmetricdevs.supersymmetry.api.particle.ParticlePhysicsUtils;
...
public class ParticleBeamRenderer implements IIngredientRenderer<ParticleBeam> {
    ...
    public List<String> getTooltip(Minecraft minecraft, ParticleBeam ingredient, ITooltipFlag tooltipFlag) {
        ...
        list.add(ChatFormatting.RED + I18n.format("susy.particlebeam.energy") + ChatFormatting.WHITE + ": " +
                ParticlePhysicsUtils.getEnergyWithUnit(ingredient.getEnergy()));
        list.add(ChatFormatting.BLUE + I18n.format("susy.particlebeam.bunch.spacing") + ChatFormatting.WHITE + ": " +
                ParticlePhysicsUtils.getSIFormat(ingredient.getBunchSpacing(), -9, "s"));
        list.add(ChatFormatting.GREEN + I18n.format("susy.particlebeam.bunch.length") + ChatFormatting.WHITE + ": " +
                ParticlePhysicsUtils.getSIFormat(ingredient.getBunchLength(), -2, "m"));
        list.add(ChatFormatting.YELLOW + I18n.format("susy.particlebeam.nbunches") + ChatFormatting.WHITE + ": " +
                String.valueOf(ingredient.getNBunches()));
        list.add(ChatFormatting.LIGHT_PURPLE + I18n.format("susy.particlebeam.nparticles") + ChatFormatting.WHITE +
                ": " + String.valueOf(ingredient.getNParticlesPerBunch()));
        list.add(ChatFormatting.AQUA + I18n.format("susy.particlebeam.emittance") + ChatFormatting.WHITE + ": " +
                String.valueOf(ingredient.getEmittance()) + " um rad");
        list.add(ChatFormatting.GOLD + I18n.format("susy.particlebeam.beamsize") + ChatFormatting.WHITE + ": " +
