...
import com.gregtechceu.gtceu.api.machine.SteamMachine;
import com.gregtechceu.gtceu.api.machine.IMachine;
import com.gregtechceu.gtceu.api.recipe.GTRecipeType;
import com.gregtechceu.gtceu.api.recipe.ingredient.IntCircuitIngredient;
import com.gregtechceu.gtceu.utils.GTTransferUtils;
import com.gregtechceu.gtceu.client.renderer.GTCEuBlockRenderer;
import io.github.symmetricdevs.supersymmetry.api.capability.impl.RecipeLogicSteamLimited;
...
public class SuSySimpleSteamMetaTileEntity extends SteamMachine implements IGhostSlotConfigurable {
    ...
    public SuSySimpleSteamMetaTileEntity(ResourceLocation metaTileEntityId, GTRecipeType<?> GTRecipeType,
                                         SuSySteamProgressIndicator progressIndicator, ICubeRenderer renderer,
                                         boolean isBrickedCasing, boolean isHighPressure) {
        this(metaTileEntityId, GTRecipeType, progressIndicator, renderer, isBrickedCasing, isHighPressure, false);
    }

    public SuSySimpleSteamMetaTileEntity(ResourceLocation metaTileEntityId, GTRecipeType<?> GTRecipeType,
                                         SuSySteamProgressIndicator progressIndicator, ICubeRenderer renderer,
                                         boolean isBrickedCasing, boolean isHighPressure, boolean ulvOnly) {
        super(metaTileEntityId, GTRecipeType, renderer, isHighPressure);
        ...
        this.workableHandler = ulvOnly ?
                new RecipeLogicSteamLimited(this, GTRecipeType, isHighPressure, steamFluidTank, 1.0) :
                new RecipeLogicSteam(this, GTRecipeType, isHighPressure, steamFluidTank, 1.0);
    }
    ...
    protected ModularUI.Builder createGuiTemplate(Player player) {
        GTRecipeType<?> GTRecipeType = workableHandler.getRecipeMap();
        int yOffset = 0;

        ModularUI.Builder builder = super.createUITemplate(player);
        addRecipeProgressBar(builder, GTRecipeType, yOffset);
    ...
    protected void addRecipeProgressBar(ModularUI.Builder builder, GTRecipeType<?> map, int yOffset) {
