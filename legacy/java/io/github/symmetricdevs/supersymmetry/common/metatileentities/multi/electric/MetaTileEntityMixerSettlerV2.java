...
public class MetaTileEntityMixerSettlerV2 extends WorkableElectricMultiblockMachine {
    ...
    protected boolean updateStructureDimensions() {
        ...
        Direction left = RelativeDirection.RIGHT.getRelativeFacing(getFrontFacing(), getUpwardsFacing(), isFlipped());
        Direction right = left.getOpposite();
        Direction back = left.rotateY();
