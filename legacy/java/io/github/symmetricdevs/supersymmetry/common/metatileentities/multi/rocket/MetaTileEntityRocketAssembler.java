...
import io.github.symmetricdevs.supersymmetry.api.recipes.logic.RocketAssemblerLogic;
...
import io.github.symmetricdevs.supersymmetry.common.mui.widget.ItemCostWidget;
import io.github.symmetricdevs.supersymmetry.common.mui.widget.SlotWidgetMentallyStable;

public class MetaTileEntityRocketAssembler extends WorkableElectricMultiblockMachine
    ...
    public DataStorageLoader blueprintSlot = new DataStorageLoader(
            ...
            x -> {
                if (x.hasTagCompound()) {
                    CompoundTag tag = x.getTagCompound();
    ...
    public CompoundTag writeToNBT(CompoundTag data) {
        ...
        data.setTag("blueprint", this.blueprintSlot.getStackInSlot(0).writeToNBT(new CompoundTag()));
    ...
    public void readFromNBT(CompoundTag data) {
        ...
        CompoundTag stackdata = (CompoundTag) data.getTag("blueprint");
        if (stackdata != null && stackdata != new CompoundTag()) {
    ...
    public AbstractRocketBlueprint getCurrentBlueprint() {
        ...
        CompoundTag tag = blueprintSlot.getStackInSlot(0).getTagCompound();
        AbstractRocketBlueprint bp = AbstractRocketBlueprint.getCopyOf(tag.getString("name"));
    ...
    public void finishAssembly() {
        ...
        if (erector != null) {
            ...
            CompoundTag rocketNBT = erector.getRocketNBT();
    ...
    public EntityTransporterErector findTransporterErector() {
        AABB internalBB = this.getInternalBB();
