...
import static com.gregtechceu.gtceu.api.capability.GregtechDataCodes.UPDATE_ACTIVE;
...
import com.gregtechceu.gtceu.api.gui.widgets.AdvancedTextWidget;
...
public class MetaTileEntityIncinerator extends TieredMetaTileEntity implements IControllable {
    ...
    protected ModularUI createUI(Player Player) {
        ...
        return createUITemplate(Player, rowSize)
    ...
    private ModularUI.Builder createUITemplate(Player player, int gridSize) {
    ...
    public void getDisplayText(List<Component> list) {
