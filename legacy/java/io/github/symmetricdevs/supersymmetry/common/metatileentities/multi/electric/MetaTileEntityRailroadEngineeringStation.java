...
import io.github.symmetricdevs.supersymmetry.client.renderer.particles.SusyParticleFlame;
...
public class MetaTileEntityRailroadEngineeringStation extends WorkableElectricMultiblockMachine {
    ...
    private Int2ObjectOpenHashMap<net.minecraft.world.item.ItemStack> rollingStockItemStackMap = new Int2ObjectOpenHashMap<>();
    ...
    @Override
    public void addInformation(net.minecraft.world.item.ItemStack stack, @Nullable net.minecraft.world.level.Level world,
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        MultiblockShapeInfo.Builder builder = MultiblockShapeInfo.builder()
                ...
                .aisle("                 ", "                 ", "                 ", "                 ",
                        "                 ", "                 ", "                 ", "                 ",
                        "       F F       ", "                 ")
                .where('S', SuSyMetaTileEntities.RAILROAD_ENGINEERING_STATION, Direction.SOUTH)
                ...
                .where('C',
                        MetaBlocks.STONE_BLOCKS.get(StoneVariantBlock.StoneVariant.SMOOTH)
                                .getState(StoneVariantBlock.StoneType.CONCRETE_LIGHT))
                .where('I', MetaTileEntities.ITEM_IMPORT_BUS[3], Direction.NORTH)
                .where('E', MetaTileEntities.ENERGY_INPUT_HATCH[3], Direction.NORTH)
                .where('H', MetaTileEntities.FLUID_IMPORT_HATCH[3], Direction.NORTH)
        ...
        PlacementInfo placementInfo = new PlacementInfo(trackBlueprintStack, 270, new Vec3(0.5, 0.5, 0.5));
    ...
    protected void updateFormedValid() {
        ...
        if (this.getOffsetTimer() % 20 == 1) {
            if (recipeMapWorkable.isActive()) {
                List<Player> players = getWorld().getEntitiesWithinAABB(Player.class, this.structureAABB);
    ...
    private net.minecraft.world.item.ItemStack getTrainItemStackFromCache(EntityRollingStock rollingStock) {
    ...
    private net.minecraft.world.item.ItemStack getTrainItemStack(EntityRollingStock rollingStock) {
    ...
    public float getTrainSpawnAngle() {
        if (this.frontFacing == Direction.NORTH) {
            return 90;
        } else if (this.frontFacing == Direction.EAST) {
            return 180;
        } else if (this.frontFacing == Direction.SOUTH) {
            return 270;
        } else {
            return 0;
        }
    ...
    public BlockPos getRailPos(net.minecraft.core.Vec3i direction) {
    ...
    public EntityRollingStock spawnRollingStock(ItemStack stack) {
        ...
        if (def != null) {
            ...
            // net.minecraft.core.Vec3i direction = this.getFrontFacing().getOpposite().getDirectionVec();
            ...
            TickPos tp = new TickPos(
                    0,
                    Speed.ZERO,
                    (new Vec3(railPos.getX(), railPos.getY(), railPos.getZ())).add(0.0, 0.25, 0.0).add(0.5, 0.0, 0.5),
                    0,
                    0,
                    0,
                    0.0F,
    ...
    public void setStructureAABB() {
        ...
        net.minecraft.core.BlockPos offsetBottomLeft = new net.minecraft.core.BlockPos(9, -1, 2);
        net.minecraft.core.BlockPos offsetTopRight = new net.minecraft.core.BlockPos(-9, 8, 7);
        ...
        this.structureAABB = new AABB(getPos().add(offsetBottomLeft), getPos().add(offsetTopRight));
    }
    ...
    public void spawnWorkingParticles() {
        SusyParticleFlame spark = new SusyParticleFlame(
                ...
                (GTValues.RNG.nextFloat() - 0.5) * 1.2F);
        Minecraft.getInstance().effectRenderer.addEffect(spark);
    }

    protected static class RailroadEngineeringStationWorkable extends RecipeLogic {

        NotifiableItemStackHandler trainOutput;
        NotifiableItemStackHandler trainInput;

        public RailroadEngineeringStationWorkable(WorkableElectricMultiblockMachine BlockEntity,
                                                  NotifiableItemStackHandler trainInput,
                                                  NotifiableItemStackHandler trainOutput) {
            super(BlockEntity);
