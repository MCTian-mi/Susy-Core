...
import io.github.symmetricdevs.supersymmetry.api.recipes.properties.MixerSettlerCellsProperty;
...
public class MetaTileEntityMixerSettler extends WorkableElectricMultiblockMachine {
    ...
    protected boolean updateStructureDimensions() {
        ...
        Direction left = RelativeDirection.LEFT.getRelativeFacing(getFrontFacing(), getUpwardsFacing(), isFlipped());
    ...
    public BlockState getSecondaryCasingState() {
    ...
    public void addInformation(ItemStack stack, @Nullable World world, @NotNull List<String> tooltip,
        ...
        tooltip.add(ChatFormatting.AQUA + I18n.format("susy.machine.mixer_settler.tooltip.1"));
        tooltip.add(ChatFormatting.AQUA + I18n.format("susy.machine.mixer_settler.tooltip.2"));
    }

    private class MixerSettlerRecipeLogic extends RecipeLogic {
