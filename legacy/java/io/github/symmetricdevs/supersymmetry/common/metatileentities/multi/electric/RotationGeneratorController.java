...
import com.gregtechceu.gtceu.api.machine.ITieredMetaTileEntity;
import com.gregtechceu.gtceu.api.machine.multiblock.FuelMultiblockController;
...
import io.github.symmetricdevs.supersymmetry.api.capability.IRotationSpeedHandler;
...
public abstract class RotationGeneratorController extends FuelMultiblockController
    ...
    public RotationGeneratorController(ResourceLocation metaTileEntityId, GTRecipeType<?> GTRecipeType, int tier,
                                       int maxSpeed, int accel, int decel) {
        super(metaTileEntityId, GTRecipeType, tier);
        this.tier = tier;
    ...
    public class SuSyTurbineRecipeLogic extends MultiblockFuelRecipeLogic {
        ...
        private RotationGeneratorController BlockEntity;
        private int proposedEUt;

        protected boolean voidEnergy = false;

        public SuSyTurbineRecipeLogic(RotationGeneratorController BlockEntity) {
            super(BlockEntity);
        ...
        public long getMaximumAllowedVoltage() {
            return Math.min((GTValues.V[BlockEntity.getTier()]) * 16, getMaxVoltage());
        }
