...
import static com.gregtechceu.gtceu.api.MetaMachine.MetaTileEntityHolder.TRACKED_TICKS;
import static io.github.symmetricdevs.supersymmetry.api.MetaMachine.multiblock.SuSyPredicates.coilsOrBeds;
...
import com.gregtechceu.gtceu.api.block.IHeatingCoilBlockStats;
...
import io.github.symmetricdevs.supersymmetry.api.recipes.properties.EvaporationEnergyProperty;
...
public class MetaTileEntityEvaporationPool extends WorkableElectricMultiblockMachine {
    ...
    protected static BlockState getConcreteState() {
    ...
    protected static BlockState getEvaporationBedState() {
    ...
    public List<MultiblockShapeInfo> getMatchingShapes() {
        ...
        builder.aisle(Slice.B_START.gen(l, r), Slice.T_MIDDLE.gen(l, r))
                ...
                .where('S', SuSyMetaTileEntities.EVAPORATION_POOL, Direction.SOUTH)
                ...
                .where('I', MetaTileEntities.FLUID_IMPORT_HATCH[GTValues.LV], Direction.NORTH)
                .where('O', MetaTileEntities.FLUID_EXPORT_HATCH[GTValues.LV], Direction.NORTH)
                .where('T', MetaTileEntities.ITEM_EXPORT_BUS[GTValues.LV], Direction.NORTH);
    ...
    /// This works the same as [WorkableElectricMultiblockMachine#isActive()]
    ...
    /// @see MultiblockControllerMachine#update()
    @Override
    ...
    public void evaporationEffect() {
        ...
        BlockPos pos = getPos().offset(Direction.UP).offset(right, i).offset(back, j);
    ...
    protected void addDisplayText(List<Component> textList) {
        MultiblockDisplayText.builder(textList, isStructureFormed())
                ...
                .addCustom(tl -> {
                    ...
                    /// IsHeating line
                    if (isStructureFormed()) {
                        Component isHeatingString = isHeating() ?
                    ...
                    /// Exposed Blocks line
                    if (isStructureFormed()) {
                        Component exposedBlocksString = TextComponentUtil.stringWithColor(
                    ...
                    if (isStructureFormed()) {
                        Component averageSpeedString = TextComponentUtil.stringWithColor(
                                ChatFormatting.AQUA,
    ...
    public class EvapRecipeLogic extends RecipeLogic {
        ...
        public EvapRecipeLogic(WorkableElectricMultiblockMachine BlockEntity) {
            super(BlockEntity);
        }

        @Override
        public boolean checkRecipe(@NotNull Recipe recipe) {
            return super.checkRecipe(recipe) && EvaporationEnergyProperty.hasEvaporationEnergy(recipe);
        }

        @Override
        protected void setupRecipe(Recipe recipe) {
            super.setupRecipe(recipe);
            this.recipeJt = EvaporationEnergyProperty.getEvaporationEnergy(recipe, 0); // TODO: is this correct?
            this.heatBuffer = 0;
        }
