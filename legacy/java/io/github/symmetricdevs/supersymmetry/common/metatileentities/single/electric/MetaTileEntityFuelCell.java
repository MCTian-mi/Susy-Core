...
import com.gregtechceu.gtceu.api.capability.NotifiableFilteredFluidHandler;
...
import com.gregtechceu.gtceu.api.gui.widgets.ProgressWidget;
...
public class MetaTileEntityFuelCell extends SimpleGeneratorMachine {
    ...
    // Initialization
    public MetaTileEntityFuelCell(ResourceLocation metaTileEntityId, GTRecipeType<?> GTRecipeType,
                                  ICubeRenderer renderer, int tier,
                                  Function<Integer, Integer> tankScalingFunction,
                                  int maxTemperature, int thresholdTemperature) {
        super(metaTileEntityId, GTRecipeType, renderer, tier, tankScalingFunction, false);
    ...
    protected FuelCellRecipeLogic createWorkable(GTRecipeType<?> GTRecipeType) {
        return new FuelCellRecipeLogic(this, GTRecipeType, () -> this.energyContainer);
    }
    ...
    protected ModularUI.Builder createGuiTemplate(Player player) {
        ...
        builder.widget(new ProgressWidget(this::getTemperaturePercent, 124, 21, 10, 54)
                ...
                .setHoverTextConsumer(list -> list.add(Component.translatable(
    ...
    private class FuelCellRecipeLogic extends FuelRecipeLogic {
        ...
        public FuelCellRecipeLogic(MetaTileEntityFuelCell MetaMachine, GTRecipeType<?> GTRecipeType,
