...
import io.github.symmetricdevs.supersymmetry.integration.immersiverailroading.control.TunnelBoreControl;
import io.github.symmetricdevs.supersymmetry.integration.immersiverailroading.gui.SuSyIRGUITypes;
...
public class EntityTunnelBore extends Locomotive {
    ...
    private boolean isNonEmptyBattery(ItemStack is) {
        net.minecraft.world.item.ItemStack internal = is.internal;
    ...
    private List<IElectricItem> getNonEmptyBatteries() {
        ...
        for (int i = 0; i < this.getBatterySlots(); ++i) {
            net.minecraft.world.item.ItemStack batteryStack = inventory.get(i).internal;
