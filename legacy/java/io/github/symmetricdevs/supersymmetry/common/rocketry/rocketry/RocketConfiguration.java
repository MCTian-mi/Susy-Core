...
import static io.github.symmetricdevs.supersymmetry.api.space.Planetoid.PLANETOIDS;
...
public class RocketConfiguration {
    ...
    public static class MissionConfiguration {
        ...
        public MissionConfiguration(CompoundTag landing) {
    ...
    public RocketConfiguration(CompoundTag tag) {
        for (int i = 0; i < 10; i++) {
            CompoundTag missionTag = tag.getCompoundTag("page_" + i);
