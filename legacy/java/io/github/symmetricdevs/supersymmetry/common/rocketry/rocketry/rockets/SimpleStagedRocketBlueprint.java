package io.github.symmetricdevs.supersymmetry.common.rocketry.rockets;
...
public class SimpleStagedRocketBlueprint extends AbstractRocketBlueprint {
    ...
    public CompoundTag writeToNBT() {
        ...
        ListTag ignitionOrder = new ListTag();
    ...
    public boolean readFromNBT(CompoundTag tag) {
        ...
        List<CompoundTag> stagesCompounds = tag.getTagList("stages", NBT.TAG_COMPOUND).tagList.stream()
                .map(x -> (CompoundTag) x)
                .collect(Collectors.toList());
