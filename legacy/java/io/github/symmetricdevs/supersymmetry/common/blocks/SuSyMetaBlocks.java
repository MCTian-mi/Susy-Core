...
import static com.gregtechceu.gtceu.api.unification.material.info.MaterialFlags.GENERATE_FRAME;
...
public class SuSyMetaBlocks {
    ...
    public static void registerColors() {
         ...
         * Minecraft.getInstance().getBlockColors().registerBlockColorHandler(FRAME_BLOCK_COLOR, block);
         * Minecraft.getInstance().getItemColors().registerItemColorHandler(FRAME_ITEM_COLOR, block);
         * });
         */
    }
