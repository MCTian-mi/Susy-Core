...
public class MapGenLunarLavaTube extends MapGenBase {
    ...
    public static final BlockState BASALT = MetaBlocks.STONE_BLOCKS.get(StoneVariantBlock.StoneVariant.SMOOTH)
    ...
    protected boolean canReplaceBlock(BlockState state, BlockState up) {
    ...
    protected void fillBlock(ChunkPrimer primer, int x, int y, int z, Boolean replace, BlockState state,
