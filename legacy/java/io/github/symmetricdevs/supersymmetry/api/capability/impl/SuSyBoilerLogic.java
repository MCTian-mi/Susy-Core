...
import static com.gregtechceu.gtceu.api.capability.GregtechDataCodes.BOILER_HEAT;
import static com.gregtechceu.gtceu.api.capability.GregtechDataCodes.BOILER_LAST_TICK_STEAM;
...
public class SuSyBoilerLogic extends AbstractRecipeLogic {
    ...
    public SuSyBoilerLogic(MetaTileEntitySuSyLargeBoiler BlockEntity) {
        super(BlockEntity, null);
    ...
    protected boolean canProgressRecipe() {
        return super.canProgressRecipe() && !(metaTileEntity instanceof IMultiblockController &&
                ((IMultiblockController) MetaMachine).isStructureObstructed());
    }
    ...
    protected void trySearchNewRecipe() {
        ...
        MetaMachine.getNotifiedItemInputList().clear();
        MetaMachine.getNotifiedFluidInputList().clear();
    }
    ...
    public void setHeat(int heat) {
        if (heat != this.currentHeat && !MetaMachine.getWorld().isRemote) {
    ...
    public void setLastTickSteam(int lastTickSteamOutput) {
        if (lastTickSteamOutput != this.lastTickSteamOutput && !MetaMachine.getWorld().isRemote) {
