...
import io.github.symmetricdevs.supersymmetry.common.metatileentities.multi.electric.MetaTileEntityQuarry;
...
public class QuarryLogic {
    ...
    public QuarryLogic(MetaTileEntityQuarry MetaMachine) {
        this.quarryTileEntity = MetaMachine;
        random = new Random();
    }
    ...
    private boolean isEastWest() {
        return quarryTileEntity.getFrontFacing() == Direction.EAST ||
                quarryTileEntity.getFrontFacing() == Direction.WEST;
    }
